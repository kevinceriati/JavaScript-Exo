...
=> Avant car c'est mieux pour optimiser le rendu de la page.
...
Les 3 principaux sélecteurs en jQuery sont :
- *      => sélectionner tous les éléments.
- #id    => sélectionner tous les éléments avec l'id.
- .class => sélectionner tous les éléments d'une class.
...
Par exemple, si je dis sélectionner tous les éléments `h4` de la page, le sélecteur associé est : `$('h4')`.
	...
	7. Sélectionner tous les paragraphes qui ont comme classe 'article'.
...
Dans le fichier script.js, vous avez une fonction getData qui vous retourne le tableau de données, notre objectif va être d'afficher ces données dans une [table HTML](https://wwwadd .w3schools.com/bootstrap/bootstrap_tables.asp) :
